...
Click here https://github.com/dhunt84971/pylogix_cli/releases/download/v0.1.0/pylogix_cli.exe to download the current standalone executable for Windows 7/10.
